...
$outputDir = ".\checkpoints\corr_latent_adapter_${AdapterMode}_${Model}_${Dataset}_sl96_pl${PredLen}"
...
Write-Host "Running Corr-Latent Adapter: mode=$AdapterMode model=$Model dataset=$Dataset pred_len=$PredLen"
Write-Host "Baseline ckpt: $baselineCkpt"

& $Python -u .\train_latenttsf_corr_latent_adapter.py `
