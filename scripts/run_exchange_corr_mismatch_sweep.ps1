...
foreach ($model in $models) {
  ...
  powershell -ExecutionPolicy Bypass -File "$PSScriptRoot\run_corr_mismatch_adapter.ps1" -Dataset "exchange_rate" -Model $model -AdapterMode $AdapterMode -Python $Python -Device $Device
}
